...
public class EsSchoolInfoService {
    ...
    public Iterable<EsSchoolInfo> boolQuery(String queryString,int schoolParentId) {
        ...
        pagesum= (int) schoolInfoRepository.search(boolQuery,pageRequest).getTotalElements()+1;
        Iterable<EsSchoolInfo> schoolInfos = schoolInfoRepository.search(boolQuery,pageRequest);
        return schoolInfos;
    }
}